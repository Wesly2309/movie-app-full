    ...
    <div class="movie info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="mt-12">
                ...
                class="flex inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-2 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
            ...
            >
                <div class="mx-auto lg:px-32 rounded-lg overflow-y-auto">
                    <div class="bg-gray-900 rounded">
                        ...
                        <div class="modal-body px-8 py-8">
                            <div class="responsive-container overflow-hidden relative" style="padding-top
                                ...
                                left-0 w-full h-full" src="https://www.youtube.com/embed/D9oIu6jiYLK"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach($movie['credits']['cast'] as $cast)
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-2">
                            <a href="#" class="text-lg mt-2 text-white hover:text-gray-300">{{ $cast['name'] }}</a>
