...
>>>>>>> 1fc63e143b3b0460882e67b931ba3650acc0dcb4
                        @endforeach
                    </div>
                </div>
...
=======
                                font-semibold px-2 py-4 hover:bg-orange-600 transition ease-in-out duration-150"
                            >
                                <svg class="w-6 fill-current" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="
                                none"/><path d="M10 16.516-4.5-6-4.5v9zM12 2C6.48. 2 2 6.48 2 12s4.48 10 10 10 
