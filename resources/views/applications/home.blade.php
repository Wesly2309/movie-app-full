    ...
    <div class="container mx-auto px-4 pt-16">
        <div class="popular-movies">
            ...
            <div class="grid grid-cols-4 gap-8">
                <div class="mt-8">
                    <a href="#">
                        <img src="asset/img/once-we-get-married-poster.jpeg" alt="Once We Get Married">
                    </a>
                    <div class="mt-2">
                        <a href="#" class="text-lg mt-2 text-white hover:text-gray-300">Once We Get Married</a>
