    ...
    <div class="container mx-auto px-4 pt-16">
        <div class="popular-movies">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/demonslayer.jpg" alt="Demon Slayer" class="hover:opacity-75 transition
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="/img/spiderman2021.jpg" alt="Spider Man 2021" class="hover:opacity-75 transition
                        ease-in-out duration-150">
                    </a>
                    <div class="mt-2">
